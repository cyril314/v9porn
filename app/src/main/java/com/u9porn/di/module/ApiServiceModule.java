...
import com.u9porn.data.network.okhttp.TLSSocketFactory;
...
public class ApiServiceModule {
	...
	@Singleton
	@Provides
	OkHttpClient providesOkHttpClient(CommonHeaderInterceptor commonHeaderInterceptor, HttpLoggingInterceptor httpLoggingInterceptor, RulerCookie rulerCookie,
	                                  MyProxySelector myProxySelector, AddressHelper addressHelper) {
		...
		RetrofitUrlManager.getInstance().putDomain(Api.MEI_ZI_TU_DOMAIN_NAME, Api.APP_MEI_ZI_TU_DOMAIN);
		RetrofitUrlManager.getInstance().putDomain(Api.XICI_DAILI_DOMAIN_NAME, Api.APP_PROXY_XI_CI_DAI_LI_DOMAIN);
