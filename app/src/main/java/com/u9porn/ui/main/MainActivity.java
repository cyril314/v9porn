	...
	private void doOnTabSelected(@IntRange(from = 0, to = 4) int position) {
		switch (position) {
			...
			case 2:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMain9ForumFragment, contentFrameLayout.getId(), position,
				                                               false);
				showFloatingActionButton(fabSearch);
				break;
			case 3:
	...
	private void handlerFirstTabClickToShow(String tag, int itemId, boolean isInnerReplace) {
		switch (tag) {
			case Tags.TAG_PRON_9_VIDEO:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMain9PronVideoFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
			...
			case Tags.TAG_PXGAV_VIDEO:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMainPxgavFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
			...
			case Tags.TAG_AXGLE_VIDEO:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mainAxgleFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
			...
			case Tags.TAG_KE_DOU_WO_VIDEO:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMainKeDouFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
	...
	private void handlerSecondTabClickToShow(String tag, int itemId, boolean isInnerReplace) {
		switch (tag) {
			case Tags.TAG_MEI_ZI_TU:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMaiMeiZiTuFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
			...
			case Tags.DOU_BAN:
				...
				mCurrentFragment = FragmentUtils.switchContent(fragmentManager, mCurrentFragment, mMainDBMeiZiFragment, contentFrameLayout.getId(), itemId,
				                                               isInnerReplace);
