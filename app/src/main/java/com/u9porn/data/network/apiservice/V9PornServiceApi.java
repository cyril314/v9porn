...
public interface V9PornServiceApi {
    ...
    @Headers({"Domain-Name: " + Api.PORN9_VIDEO_DOMAIN_NAME})
    @GET("/view_video.php")
    Observable<String> getVideoPlayPage(@Query("viewkey") String vkey, @Header("User-Agent") String ua, @Header("Referer") String ref);
     ...
     * @return ob
     */
    @Headers({"X-Requested-With: XMLHttpRequest", "Domain-Name: " + Api.PORN9_VIDEO_DOMAIN_NAME})
